...
//       <input {...register('email', { required: 'Email là bắt buộc' })} placeholder="Email" />
//       {errors.email && <p>{errors.email.message}</p>}

//       <input type="password" {...register('password', { required: 'Mật khẩu là bắt buộc' })} placeholder="Mật khẩu" />
//       {errors.password && <p>{errors.password.message}</p>}

//       <button type="submit">Đăng nhập</button>
//       <button type="button" onClick={loginWithGoogle}>Đăng nhập với Google</button>
//       <button type="button" onClick={loginWithFacebook}>Đăng nhập với Facebook</button>
//     </form>
//   );
// };
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="mt-6 text-center">
        ...
        <Link to="/forgot-password" className="block mt-2 text-emerald-600 hover:text-emerald-700">
          Quên mật khẩu?
        </Link>
      </div>
    </div>
